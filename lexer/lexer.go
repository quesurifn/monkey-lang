...
func (l *Lexer) readDigit() string {
	position := l.position
	for isDigit(l.ch) {
		println("Read Digit Char")
		l.readChar()
	}

	println("Digit", l.input[position:l.position])
	return l.input[position:l.position]
}

func (l *Lexer) consumeWhitespace() {
	for isWhitespace(l.ch) {
		println("Consume Whitespace")
		l.readChar()
	}
}
...
func isLetter(ch byte) bool {
	...
	return isUppercase || isLowercase || isUnderscore
}
